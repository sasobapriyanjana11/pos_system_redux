    ...
    return (
        <div className=" md-8">
            ...
            <div  className="p-6 grid grid-cols-2" >
                {/* left  */}
                <div>
                    <h1 className="text-3xl font-medium text-purple-700 mb-6">Customer Details</h1>
                ...
                <div>
                    <div className="item-card">
                        <h1 className="text-3xl font-medium text-purple-700 mb-6">Item Details</h1>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
                            {item.map((item) => (
                                <div className="bg-gray-200 shadow-md rounded-lg p-4 border border-gray-200 hover:bg-green-200 transition duration-500">
